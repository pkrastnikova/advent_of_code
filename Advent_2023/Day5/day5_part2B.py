...
def find_subranges_in_map(source_start, source_end, maps):
    ...
    for map in maps:     
        ...
        #print(map_start, map_end, source_start, source_end)
        if map_start <= source_start and map_end >= source_end: 
            #print("case 1")           
            found_ranges.append(convert_mapped_ranges(map, list(range(source_start, source_end +1))))
            ...
            #print("case 3") 
            new_range = convert_mapped_ranges(map, list(range(current_point, map_end + 1)))
            ...
            if map_start > current_point:
                new_range_1 = list(range(current_point, map_start + 1))
                found_ranges.append(new_range_1)
            new_range_2 = convert_mapped_ranges(map, list(range(map_start, map_end + 1)))            
            ...
            if map_start > current_point:
                new_range_1 = list(range(current_point, map_start + 1))
                found_ranges.append(new_range_1)
            new_range_2 = convert_mapped_ranges(map, list(range(map_start, source_end + 1)))            
            found_ranges.append(new_range_2)
            #print("Found ranges: ", found_ranges)
            current_point = source_end
            break
    ...
    if current_point < source_end:
        found_ranges.append(list(range(current_point, source_end + 1)))
